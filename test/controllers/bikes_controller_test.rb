...
class BikesControllerTest < ActionController::TestCase
  ...
  test "should create bike" do
    assert_difference('Bike.count') do
      post :create, bike: { days: @bike.days, description: @bike.description, image_url: @bike.image_url, price: @bike.price }
    end
  ...
  test "should update bike" do
    patch :update, id: @bike, bike: { days: @bike.days, description: @bike.description, image_url: @bike.image_url, price: @bike.price }
    assert_redirected_to bike_path(assigns(:bike))
  end
